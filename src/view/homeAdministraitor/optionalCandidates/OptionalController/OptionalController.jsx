        ...
        <div className={style.container}>
          <div className={style.listOptions}>
            <div className={style.titlle}>
              <span>Opciones de Contralor</span>
            </div>
            <div className={style.options}>
              <div className={style.optionItem}>
                <LinksAcctions title={"Cargar un Contralor"} to="/BuscarEstudiantesContralores" />
                <svg
              ...
              <div className={style.optionItem}>
                <LinksAcctions title={"Listar Contralores"} to={"/ContraloresRegistrados"} />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="40"
                  height="40"
