...
export const BuscarEstuRepresentates = () => {
    ...
    localStorage.setItem('jwtToken', 'eyJhbGciOiJIUzM4NCJ9.eyJpZGVudGlmaWNhdGlvbiI6MSwic3ViIjoicHJ1ZWJhMTIzNDUiLCJpYXQiOjE3MTQ2MjIyNDIsImV4cCI6MTcxNDcwODY0Mn0.CBdlXXxKtwyOCQqh2e-RZ9GAxFNOchyOOS7zUWd3rHZ6Hn7J1q4lVgO4yTTw8_7t');
    ...
    return (
        <div className="container">
            ...
            <div className='titulo'>
                <h2>Buscar Estudiante Representante</h2>
